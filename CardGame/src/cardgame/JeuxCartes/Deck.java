 ...
 * @version 1.0 08-Fév-2016 : 1.0 - Version initiale. 1.1 10-Fév-2016 : 1.1 -
 * Modification de InitialiserDeck pour utiliser PersoFactory.
 */
public class Deck {
    ...
    /**
     * Permet de créer le deck et d'initialiser son contenu. La classe
     * initialise le nombre de cartes nécessaire de chaque type selon les règles
     * du jeu et ensuite mélange le deck.
     */
    ...
    /**
     * Pemet d'avoir la représentation en JSon du Deck A noter : Le contenu du
     * deck n'est pas communiqué pour éviter la triche.
     *
